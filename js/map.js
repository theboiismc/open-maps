...
const map = new maplibregl.Map({
    ...
    center: [-95, 39],
    zoom: 4,
    // Disable pitch (tilt) and rotation controls
    pitchWithRotate: false,
    dragRotate: false,
    touchZoomRotate: false,
    keyboard: false,
    // Restore specific interactions you still want
    dragPan: true,
    scrollZoom: true,
    touchZoom: true,
...
// Explicitly disable rotation handlers to ensure the map is not tiltable or rotatable

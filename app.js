...
// Remove default controls and add custom ones
map.removeControl(new maplibregl.NavigationControl());  // Remove MapLibre's top-left controls
map.addControl(new maplibregl.NavigationControl({ showZoom: false, showCompass: false }), 'bottom-right');
